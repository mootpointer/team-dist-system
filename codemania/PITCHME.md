...
<!-- I'm not even sure if I want to include the above paragraph, but it was a thought I had so I've thrown it in for now. -->
...
Note:
What you're building is a monolith. Don't build a monolith. It will not scale with you over the long term, and we're in this for the long term right.
...
To borrow from a friend of ours: culture is who we hire. It is who we hire. It is the behaviours we reprimand and those we reward. It is the hard calls we make because they are the right thing to do, even if there is a more expedient way.
